                    ...
                    <div style={{ backgroundColor: bgColor }} className="editor-section flex-column align-item m-auto">
                        ...
                        <section className="editor-bottom-btn flex jstfy-ctnt-spc-between">
                            <span className="relative">
                                <button onClick={() => setColorBtn(colorBtn ? false : true)} className="editor-style-btn"><img className="bottom-style-icon" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTL3i8FKZSq7YQ8R5Pb85NchQb7Vh2kjGd0NA&usqp=CAU" alt="color logo" /></button>
                                ...
                                <button onClick={() => setPriorityBtn(priorityBtn ? false : true)} className="editor-style-btn"><img className="bottom-style-icon" src="https://www.svgrepo.com/show/68349/business-bars-graphic.svg" alt="chart logo" /></button>
